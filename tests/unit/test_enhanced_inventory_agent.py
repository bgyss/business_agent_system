...
from agents.inventory_agent_enhanced import (
    EnhancedInventoryAgent, DemandForecast, OptimalReorderPoint, 
    BulkPurchaseOptimization, ExpiryIntelligence, SupplierPerformance
)
from agents.base_agent import AgentDecision
from models.inventory import Item, StockMovement, Supplier, StockMovementType, ItemStatus
...
class TestEnhancedInventoryAgent:
    ...
    def mock_anthropic(self):
        ...
        with patch('agents.base_agent.Anthropic') as mock_client:
            mock_response = Mock()
            mock_response.content = [Mock(text="Enhanced inventory analysis: Optimize reorder points")]
