...
class TestBusinessAgentSystem:
    ...
    @patch('main.InventoryAgent')
    @patch('main.HRAgent')
    async def test_run_simulation_mode(self, mock_hr, mock_inventory, mock_accounting, mock_simulator_class, system):
    ...
    def test_get_system_status(self, system):
        ...
        mock_agent.decisions_log = []
        system.agents = {
            "accounting": mock_agent,
            "inventory": mock_agent,
            "hr": mock_agent
        }
...
class TestMainFunction:
    ...
    async def test_main_config_not_found(self, mock_print, mock_exists):
        ...
        mock_print.assert_called_with("Error: Configuration file '/non/existent/file.yaml' not found")
