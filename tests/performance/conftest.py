...
def performance_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "database": {
            "url": "sqlite:///performance_test.db"
        },
        "agents": {
            "accounting": {
                "enabled": True,
...
def medium_dataset(test_db_session):
    ...
    # Create test accounts
    accounts = [
        Account(id="med_checking", name="Medium Checking", account_type="checking", balance=100000.0),
...
def large_dataset(test_db_session):
    ...
    # Create test accounts
    accounts = [
        Account(id="large_checking", name="Large Checking", account_type="checking", balance=1000000.0),
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "database: mark test as a database performance test"
    )
    config.addinivalue_line(
        "markers", "agent: mark test as an agent performance test"
    )
    config.addinivalue_line(
        "markers", "simulation: mark test as a simulation performance test"
    )